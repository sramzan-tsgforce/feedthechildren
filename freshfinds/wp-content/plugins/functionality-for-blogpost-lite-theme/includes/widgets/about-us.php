...
class vh_aboutus extends WP_Widget {
	public function vh_aboutus() {
		$widget_options = array(
			...
			'description' => __('Display an information about your site.', 'functionality-for-blogpostlite-theme')
		);
		parent::__construct('vh_aboutus', __('BlogPost - About Us', 'functionality-for-blogpostlite-theme') , $widget_options);
	}
	...
	public function form($instance) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('content')); ?>"><?php _e('Content:', 'functionality-for-blogpostlite-theme'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('googleplus')); ?>"><?php _e('Google+ URL:', 'functionality-for-blogpostlite-theme'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('pinterest')); ?>"><?php _e('Pinterest URL:', 'functionality-for-blogpostlite-theme'); ?></label>
			<input class="widefat" id="<?php echo esc_attr($this->get_field_id('pinterest')); ?>" name="<?php echo esc_attr($this->get_field_name('pinterest')); ?>" type="text" value="<?php echo esc_attr($pinterest); ?>" />
		</p>

		<p>
			<label for="<?php echo esc_attr($this->get_field_id('vkontakte')); ?>"><?php _e('VKontakte URL:', 'functionality-for-blogpostlite-theme'); ?></label>
...
add_action( 'widgets_init', create_function( '', 'register_widget( "vh_aboutus" );' ) );