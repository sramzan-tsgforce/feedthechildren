...
class vh_googlemap extends WP_Widget {
	public function vh_googlemap() {
		$widget_options = array(
			...
			'description' => __('Displays a google map.', 'functionality-for-blogpostlite-theme')
		);
		parent::__construct('gmap', __('BlogPost - Google map', 'functionality-for-blogpostlite-theme') , $widget_options);
	}
	...
	public function form($instance) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('address')); ?>"><?php _e('Address:', 'functionality-for-blogpostlite-theme'); ?></label>
			<input class="widefat" id="<?php echo esc_attr($this->get_field_id('address')); ?>" name="<?php echo esc_attr($this->get_field_name('address')); ?>" type="text" value="<?php echo esc_attr($address); ?>" />
			<small><?php _e('Choose an address or latitute and logtitude', 'functionality-for-blogpostlite-theme')?></small>
		</p>

		<p>
			<label for="<?php echo esc_attr($this->get_field_id('latitude')); ?>"><?php _e('Latitude:', 'functionality-for-blogpostlite-theme'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('longitude')); ?>"><?php _e('Longitude:', 'functionality-for-blogpostlite-theme'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('zoom')); ?>"><?php _e('Zoom level:', 'functionality-for-blogpostlite-theme'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('html')); ?>"><?php _e('Content for the marker:', 'functionality-for-blogpostlite-theme'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('popup')); ?>"><?php _e('Auto popup the info?', 'functionality-for-blogpostlite-theme'); ?></label>
		</p>

		<p>
			<label for="<?php echo esc_attr($this->get_field_id('height')); ?>"><?php _e('Height:', 'functionality-for-blogpostlite-theme'); ?></label>
...
add_action( 'widgets_init', create_function( '', 'register_widget( "vh_googlemap" );' ) );