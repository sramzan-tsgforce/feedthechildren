...
class FastFlickrWidget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'BlogPost - Fast Flickr Widget', // Name
			array( 'description' => __( 'Flickr Images', 'functionality-for-blogpostlite-theme' ), ) // Args
		);
	...
	public function form( $instance ) {
		...
		?>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php _e("Fast Flickr Title:", 'functionality-for-blogpostlite-theme'); ?> <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr($title) ?>" /></label></p>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>"><?php _e("Flickr RSS URL or Screen name:", 'functionality-for-blogpostlite-theme'); ?> <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'username' ) ); ?>" type="text" value="<?php echo esc_attr($username); ?>" /></label></p>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'view' ) ); ?>"><?php _e("Thumbnail, square or medium?", 'functionality-for-blogpostlite-theme'); ?>
		...
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'before_item' ) ); ?>"><?php _e("Before item:", 'functionality-for-blogpostlite-theme'); ?> <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'before_item' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'before_item' ) ); ?>" type="text" value="<?php echo esc_attr($before_item); ?>" /></label></p>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'after_item' ) ); ?>"><?php _e("After item:", 'functionality-for-blogpostlite-theme'); ?> <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'after_item' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'after_item' ) ); ?>" type="text" value="<?php echo esc_attr($after_item); ?>" /></label></p>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'before_widget' ) ); ?>"><?php _e("Before widget:", 'functionality-for-blogpostlite-theme'); ?> <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'before_widget' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'before_widget' ) ); ?>" type="text" value="<?php echo esc_attr($before_flickr_widget); ?>" /></label></p>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'after_widget' ) ); ?>"><?php _e("After widget:", 'functionality-for-blogpostlite-theme'); ?> <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'after_widget' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'after_widget' ) ); ?>" type="text" value="<?php echo esc_attr($after_flickr_widget); ?>" /></label></p>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'items' ) ); ?>"><?php _e("How many items?", 'functionality-for-blogpostlite-theme'); ?> <select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'items' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'items' ) ); ?>"><?php for ( $i = 1; $i <= 20; ++$i ) echo "<option value=\"$i\" ".($items==$i ? "selected=\"selected\"" : "").">$i</option>"; ?></select></label></p>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'more_title' ) ); ?>"><?php _e("More link anchor text:", 'functionality-for-blogpostlite-theme'); ?> <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'more_title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'more_title' ) ); ?>" type="text" value="<?php echo esc_attr($more_title); ?>" /></label></p>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'tags' ) ); ?>"><?php _e("Filter by tags (comma seperated):", 'functionality-for-blogpostlite-theme'); ?> <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'tags' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'tags' ) ); ?>" type="text" value="<?php echo esc_attr($tags); ?>" /></label></p>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'target' ) ); ?>"><input id="<?php echo esc_attr( $this->get_field_id( 'target' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'target' ) ); ?>" type="checkbox" value="checked" <?php echo $target; ?> /> <?php _e("Target: _blank", 'functionality-for-blogpostlite-theme'); ?></label></p>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'show_titles' ) ); ?>"><input id="<?php echo esc_attr( $this->get_field_id( 'show_titles' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'show_titles' ) ); ?>" type="checkbox" value="checked" <?php echo $show_titles; ?> /> <?php _e("Display titles", 'functionality-for-blogpostlite-theme'); ?></label></p>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'thickbox' ) ); ?>"><input id="<?php echo esc_attr( $this->get_field_id( 'thickbox' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'thickbox' ) ); ?>" type="checkbox" value="checked" <?php echo $thickbox; ?> /> <?php _e("Use Thickbox", 'functionality-for-blogpostlite-theme'); ?></label></p>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'random' ) ); ?>"><input id="<?php echo esc_attr( $this->get_field_id( 'random' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'random' ) ); ?>" type="checkbox" value="checked" <?php echo $random; ?> /> <?php _e("Random pick", 'functionality-for-blogpostlite-theme'); ?></label></p>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'random_tag' ) ); ?>"><input id="<?php echo esc_attr( $this->get_field_id( 'random_tag' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'random_tag' ) ); ?>" type="checkbox" value="checked" <?php echo $randomTag; ?> /> <?php _e("Use random tag (needs random pick enable)", 'functionality-for-blogpostlite-theme'); ?></label></p>
		<?php 
	}
