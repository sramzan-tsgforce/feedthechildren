...
class wpb_widget_recent_comments extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__('BlogPost - Recent comments', 'functionality-for-blogpostlite-theme'), 

			// Widget description
			array( 'description' => __( 'Just a simple widget that displays recent comments.', 'functionality-for-blogpostlite-theme' ), ) 
		);
	}
			...
			<div class='recent-activities'>
				<div class='info-container empty'>
					<div class='main-item-text'>";
						_e('There hasn\'t been any activity in this listing.', 'functionality-for-blogpostlite-theme');
					echo "
					</div>
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'limit' ) ); ?>"><?php _e( 'Whats the limit?:', 'functionality-for-blogpostlite-theme' ); ?></label>
...
add_action( 'widgets_init', create_function( '', 'register_widget( "wpb_widget_recent_comments" );' ) );