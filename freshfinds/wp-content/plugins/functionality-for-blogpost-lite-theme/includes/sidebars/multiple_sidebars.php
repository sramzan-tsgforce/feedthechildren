				...
				if (is_array($sidebars) && !empty($sidebars)) {
					...
					foreach ($sidebars as $sidebar) {
						...
						<tr class="<?php echo esc_attr( $alt ); ?>">
							...
							<td><a href="javascript:void(0);" onclick="return remove_sidebar_link('<?php echo esc_attr( $sidebar['name'] ); ?>',<?php echo esc_attr( $cnt ) + 1; ?>);" title="Remove this sidebar">remove</a></td>
						</tr>
						<?php
						$cnt++;
					}
...
function vh_widgets_init() {
	...
	register_sidebar(array(
		'name' => __('Footer Area One', 'functionality-for-blogpostlite-theme'),
		'id' => 'sidebar-1',
		'description' => __('', 'functionality-for-blogpostlite-theme'),
	...
	register_sidebar(array(
		'name' => __('Footer Area Two', 'functionality-for-blogpostlite-theme'),
		'id' => 'sidebar-2',
		'description' => __('', 'functionality-for-blogpostlite-theme'),
		'before_widget' => '<div id="%1$s" class="widget %2$s row-fluid">',
		'after_widget' => '<div class="clearfix"></div></div>',
	...
	register_sidebar(array(
		'name' => __('Footer Area Three', 'functionality-for-blogpostlite-theme'),
		'id' => 'sidebar-3',
		'description' => __('', 'functionality-for-blogpostlite-theme'),
		'before_widget' => '<div id="%1$s" class="widget %2$s row-fluid">',
		'after_widget' => '<div class="clearfix"></div></div>',
	...
	register_sidebar(array(
		'name' => __('Footer Area Four', 'functionality-for-blogpostlite-theme'),
		'id' => 'sidebar-4',
		'description' => __('', 'functionality-for-blogpostlite-theme'),
		'before_widget' => '<div id="%1$s" class="widget %2$s row-fluid">',
		'after_widget' => '<div class="clearfix"></div></div>',
