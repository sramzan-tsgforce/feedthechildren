	...
	class vhFeaturedImages {
		...
		public function kd_admin_init() {
			wp_enqueue_script(
					...
					plugin_dir_url( __FILE__ ).'/js/kd-admin.js',
					'jquery'
			);
		}
...
function kd_mfi_get_featured_image_id( $image_id, $post_type, $post_id = NULL ) {
	return vhFeaturedImages::get_featured_image_id( $image_id, $post_type, $post_id );
}

function kd_mfi_get_featured_image_url( $image_id, $post_type, $size = 'full', $post_id = NULL ) {
	return vhFeaturedImages::get_featured_image_url( $image_id, $post_type, $size, $post_id );
}

function kd_mfi_get_the_featured_image( $image_id, $post_type, $size = 'full', $post_id = NULL ) {
	return vhFeaturedImages::get_the_featured_image( $image_id, $post_type, $size, $post_id );
}

function kd_mfi_the_featured_image( $image_id, $post_type, $size = 'full', $post_id = NULL ) {
	return vhFeaturedImages::the_featured_image( $image_id, $post_type, $size, $post_id );
}